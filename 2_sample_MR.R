...
#LD clumping: ensure SNPs are indepdendent; defualt r.sq = 0.001
...
write.csv(res_single, "./Results_file_single_snp.csv", row.names=F, quote=F)
...
dat$prevalence.exposure <-0.02272528
dat$ncase.exposure <- 779
dat$ncontrol.exposure <- 33480
  
dat$prevalence.outcome <-0.3043401
dat$ncase.outcome <- 24087
dat$ncontrol.outcome <-55058
